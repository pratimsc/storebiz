...
/** */
public final class CountyMeta extends org.slim3.datastore.ModelMeta<biz.storebiz.db.entity.common.County> {

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.County> countryCode = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.County>(this, "countryCode", "countryCode");
    ...
    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.County> countyCode = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.County>(this, "countyCode", "countyCode");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.County> countyCodeType = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.County>(this, "countyCodeType", "countyCodeType");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.County, com.google.appengine.api.datastore.Key> countyKey = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.County, com.google.appengine.api.datastore.Key>(this, "__key__", "countyKey", com.google.appengine.api.datastore.Key.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.County> countyName = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.County>(this, "countyName", "countyName");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.County, java.util.Date> creationDate = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.County, java.util.Date>(this, "creationDate", "creationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.County> language = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.County>(this, "language", "language");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.County, java.util.Date> lastModificationDate = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.County, java.util.Date>(this, "lastModificationDate", "lastModificationDate", java.util.Date.class);
    ...
    /** */
    public CountyMeta() {
        super("County", biz.storebiz.db.entity.common.County.class);
    }

    @Override
    public biz.storebiz.db.entity.common.County entityToModel(com.google.appengine.api.datastore.Entity entity) {
        biz.storebiz.db.entity.common.County model = new biz.storebiz.db.entity.common.County();
    ...
    public com.google.appengine.api.datastore.Entity modelToEntity(java.lang.Object model) {
        biz.storebiz.db.entity.common.County m = (biz.storebiz.db.entity.common.County) model;
    ...
    protected long getVersion(Object model) {
        throw new IllegalStateException("The version property of the model(biz.storebiz.db.entity.common.County) is not defined.");
    }
    ...
    @Override
    protected biz.storebiz.db.entity.common.County jsonToModel(org.slim3.datastore.json.JsonRootReader rootReader, int maxDepth, int currentDepth) {
        biz.storebiz.db.entity.common.County m = new biz.storebiz.db.entity.common.County();
