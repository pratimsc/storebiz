...
//@javax.annotation.Generated(value = { "slim3-gen", "@VERSION@" }, date = "2011-07-27 20:55:08")
/** */
public final class ProductDepartmentMeta extends org.slim3.datastore.ModelMeta<biz.storebiz.db.entity.product.ProductDepartment> {

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment, java.util.Date> creationDate = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment, java.util.Date>(this, "creationDate", "creationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment, java.util.Date> departmentClosingDate = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment, java.util.Date>(this, "departmentClosingDate", "departmentClosingDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment, java.util.Date> departmentFormationDate = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment, java.util.Date>(this, "departmentFormationDate", "departmentFormationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment, java.util.Date> departmentLastUpateDate = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment, java.util.Date>(this, "departmentLastUpateDate", "departmentLastUpateDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment, java.lang.Boolean> operational = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment, java.lang.Boolean>(this, "operational", "operational", boolean.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment> productDepartmentCode = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment>(this, "productDepartmentCode", "productDepartmentCode");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment, com.google.appengine.api.datastore.Key> productDepartmentKey = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment, com.google.appengine.api.datastore.Key>(this, "__key__", "productDepartmentKey", com.google.appengine.api.datastore.Key.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment> productDepartmentName = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment>(this, "productDepartmentName", "productDepartmentName");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment, com.google.appengine.api.datastore.Key> warehouseLocation = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment, com.google.appengine.api.datastore.Key>(this, "warehouseLocation", "warehouseLocation", com.google.appengine.api.datastore.Key.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment> warehouseLocationCode = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.product.ProductDepartment>(this, "warehouseLocationCode", "warehouseLocationCode");
    ...
    public ProductDepartmentMeta() {
        super("ProductDepartment", biz.storebiz.db.entity.product.ProductDepartment.class);
    }

    @Override
    public biz.storebiz.db.entity.product.ProductDepartment entityToModel(com.google.appengine.api.datastore.Entity entity) {
        biz.storebiz.db.entity.product.ProductDepartment model = new biz.storebiz.db.entity.product.ProductDepartment();
    ...
    public com.google.appengine.api.datastore.Entity modelToEntity(java.lang.Object model) {
        biz.storebiz.db.entity.product.ProductDepartment m = (biz.storebiz.db.entity.product.ProductDepartment) model;
    ...
    protected long getVersion(Object model) {
        throw new IllegalStateException("The version property of the model(biz.storebiz.db.entity.product.ProductDepartment) is not defined.");
    }
    ...
    @Override
    protected biz.storebiz.db.entity.product.ProductDepartment jsonToModel(org.slim3.datastore.json.JsonRootReader rootReader, int maxDepth, int currentDepth) {
        biz.storebiz.db.entity.product.ProductDepartment m = new biz.storebiz.db.entity.product.ProductDepartment();
