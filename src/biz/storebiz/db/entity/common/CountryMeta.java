...
//@javax.annotation.Generated(value = { "slim3-gen", "@VERSION@" }, date = "2011-07-27 20:55:11")
/** */
public final class CountryMeta extends org.slim3.datastore.ModelMeta<biz.storebiz.db.entity.common.Country> {

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.Country> countryCode = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.Country>(this, "countryCode", "countryCode");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.Country> countryCodeType = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.Country>(this, "countryCodeType", "countryCodeType");
    ...
    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.Country> countryName = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.Country>(this, "countryName", "countryName");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.Country, java.util.Date> creationDate = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.Country, java.util.Date>(this, "creationDate", "creationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.Country> language = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.Country>(this, "language", "language");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.Country, java.util.Date> lastModificationDate = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.Country, java.util.Date>(this, "lastModificationDate", "lastModificationDate", java.util.Date.class);
    ...
    /** */
    public CountryMeta() {
        super("Country", biz.storebiz.db.entity.common.Country.class);
    }

    @Override
    public biz.storebiz.db.entity.common.Country entityToModel(com.google.appengine.api.datastore.Entity entity) {
        biz.storebiz.db.entity.common.Country model = new biz.storebiz.db.entity.common.Country();
    ...
    public com.google.appengine.api.datastore.Entity modelToEntity(java.lang.Object model) {
        biz.storebiz.db.entity.common.Country m = (biz.storebiz.db.entity.common.Country) model;
    ...
    protected long getVersion(Object model) {
        throw new IllegalStateException("The version property of the model(biz.storebiz.db.entity.common.Country) is not defined.");
    }
    ...
    @Override
    protected biz.storebiz.db.entity.common.Country jsonToModel(org.slim3.datastore.json.JsonRootReader rootReader, int maxDepth, int currentDepth) {
        biz.storebiz.db.entity.common.Country m = new biz.storebiz.db.entity.common.Country();
