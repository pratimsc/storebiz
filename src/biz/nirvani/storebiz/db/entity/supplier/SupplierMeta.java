...
/** */
public final class SupplierMeta extends org.slim3.datastore.ModelMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier> {

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier, java.util.Date> creationDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier, java.util.Date>(this, "creationDate", "creationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier, java.util.Date> lastModificationDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier, java.util.Date>(this, "lastModificationDate", "lastModificationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier> primaryAddressCountry = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier>(this, "primaryAddressCountry", "primaryAddressCountry");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier> primaryAddressCountryCode = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier>(this, "primaryAddressCountryCode", "primaryAddressCountryCode");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier> primaryAddressCounty = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier>(this, "primaryAddressCounty", "primaryAddressCounty");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier> primaryAddressCountyCode = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier>(this, "primaryAddressCountyCode", "primaryAddressCountyCode");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier, java.util.Date> registrationDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier, java.util.Date>(this, "registrationDate", "registrationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier, java.util.Date> registrationExpiryDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier, java.util.Date>(this, "registrationExpiryDate", "registrationExpiryDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier> status = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier>(this, "status", "status");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier> supplierId = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier>(this, "supplierId", "supplierId");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier, com.google.appengine.api.datastore.Key> supplierKey = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier, com.google.appengine.api.datastore.Key>(this, "__key__", "supplierKey", com.google.appengine.api.datastore.Key.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier> supplierName = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.supplier.Supplier>(this, "supplierName", "supplierName");
    ...
    /** */
    public SupplierMeta() {
        super("Supplier", biz.nirvani.storebiz.db.entity.supplier.Supplier.class);
    }

    @Override
    public biz.nirvani.storebiz.db.entity.supplier.Supplier entityToModel(com.google.appengine.api.datastore.Entity entity) {
        biz.nirvani.storebiz.db.entity.supplier.Supplier model = new biz.nirvani.storebiz.db.entity.supplier.Supplier();
        ...
        java.util.List<biz.nirvani.storebiz.db.entity.common.Address> _postalAddresses = blobToSerializable((com.google.appengine.api.datastore.Blob) entity.getProperty("postalAddresses"));
    ...
    public com.google.appengine.api.datastore.Entity modelToEntity(java.lang.Object model) {
        biz.nirvani.storebiz.db.entity.supplier.Supplier m = (biz.nirvani.storebiz.db.entity.supplier.Supplier) model;
    ...
    protected long getVersion(Object model) {
        throw new IllegalStateException("The version property of the model(biz.nirvani.storebiz.db.entity.supplier.Supplier) is not defined.");
    }
    ...
    protected void modelToJson(org.slim3.datastore.json.JsonWriter writer, java.lang.Object model, int maxDepth, int currentDepth) {
        ...
        if(m.getPostalAddresses() != null){
            ...
            // biz.nirvani.storebiz.db.entity.common.Address is not supported.
        }
    ...
    @Override
    protected biz.nirvani.storebiz.db.entity.supplier.Supplier jsonToModel(org.slim3.datastore.json.JsonRootReader rootReader, int maxDepth, int currentDepth) {
        biz.nirvani.storebiz.db.entity.supplier.Supplier m = new biz.nirvani.storebiz.db.entity.supplier.Supplier();
