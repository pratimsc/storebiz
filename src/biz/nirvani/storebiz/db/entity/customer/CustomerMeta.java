...
//@javax.annotation.Generated(value = { "slim3-gen", "@VERSION@" }, date = "2011-07-13 18:56:27")
/** */
public final class CustomerMeta extends org.slim3.datastore.ModelMeta<biz.nirvani.storebiz.db.entity.customer.Customer> {

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, java.util.Date> creationDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, java.util.Date>(this, "creationDate", "creationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer> customerId = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer>(this, "customerId", "customerId");
    ...
    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, java.util.Date> customerLastModificationDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, java.util.Date>(this, "customerLastModificationDate", "customerLastModificationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, java.util.Date> customerRegistrationDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, java.util.Date>(this, "customerRegistrationDate", "customerRegistrationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, java.util.Date> customerRegistrationExpiryDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, java.util.Date>(this, "customerRegistrationExpiryDate", "customerRegistrationExpiryDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer> customerType = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer>(this, "customerType", "customerType");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, com.google.appengine.api.datastore.Email> email = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, com.google.appengine.api.datastore.Email>(this, "email", "email", com.google.appengine.api.datastore.Email.class);

    /** */
    public final org.slim3.datastore.UnindexedAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, biz.nirvani.storebiz.db.entity.customer.EmailPreference> emailPreference = new org.slim3.datastore.UnindexedAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, biz.nirvani.storebiz.db.entity.customer.EmailPreference>(this, "emailPreference", "emailPreference", biz.nirvani.storebiz.db.entity.customer.EmailPreference.class);

    /** */
    public final org.slim3.datastore.UnindexedAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, biz.nirvani.storebiz.db.entity.customer.EmailSubscription> emailSubscription = new org.slim3.datastore.UnindexedAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, biz.nirvani.storebiz.db.entity.customer.EmailSubscription>(this, "emailSubscription", "emailSubscription", biz.nirvani.storebiz.db.entity.customer.EmailSubscription.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer> name = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer>(this, "name", "name");

    /** */
    public final org.slim3.datastore.UnindexedAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, biz.nirvani.storebiz.db.entity.customer.Password> password = new org.slim3.datastore.UnindexedAttributeMeta<biz.nirvani.storebiz.db.entity.customer.Customer, biz.nirvani.storebiz.db.entity.customer.Password>(this, "password", "password", biz.nirvani.storebiz.db.entity.customer.Password.class);
    ...
    /** */
    public CustomerMeta() {
        super("Customer", biz.nirvani.storebiz.db.entity.customer.Customer.class);
    }

    @Override
    public biz.nirvani.storebiz.db.entity.customer.Customer entityToModel(com.google.appengine.api.datastore.Entity entity) {
        biz.nirvani.storebiz.db.entity.customer.Customer model = new biz.nirvani.storebiz.db.entity.customer.Customer();
        ...
        biz.nirvani.storebiz.db.entity.customer.EmailPreference _emailPreference = blobToSerializable((com.google.appengine.api.datastore.Blob) entity.getProperty("emailPreference"));
        model.setEmailPreference(_emailPreference);
        biz.nirvani.storebiz.db.entity.customer.EmailSubscription _emailSubscription = blobToSerializable((com.google.appengine.api.datastore.Blob) entity.getProperty("emailSubscription"));
        model.setEmailSubscription(_emailSubscription);
        model.setName((java.lang.String) entity.getProperty("name"));
        biz.nirvani.storebiz.db.entity.customer.Password _password = blobToSerializable((com.google.appengine.api.datastore.Blob) entity.getProperty("password"));
    ...
    public com.google.appengine.api.datastore.Entity modelToEntity(java.lang.Object model) {
        biz.nirvani.storebiz.db.entity.customer.Customer m = (biz.nirvani.storebiz.db.entity.customer.Customer) model;
    ...
    protected long getVersion(Object model) {
        throw new IllegalStateException("The version property of the model(biz.nirvani.storebiz.db.entity.customer.Customer) is not defined.");
    }
    ...
    @Override
    protected biz.nirvani.storebiz.db.entity.customer.Customer jsonToModel(org.slim3.datastore.json.JsonRootReader rootReader, int maxDepth, int currentDepth) {
        biz.nirvani.storebiz.db.entity.customer.Customer m = new biz.nirvani.storebiz.db.entity.customer.Customer();
        ...
        m.setEmailPreference(decoder0.decode(reader, m.getEmailPreference(), biz.nirvani.storebiz.db.entity.customer.EmailPreference.class));
        reader = rootReader.newObjectReader("emailSubscription");
        m.setEmailSubscription(decoder0.decode(reader, m.getEmailSubscription(), biz.nirvani.storebiz.db.entity.customer.EmailSubscription.class));
        reader = rootReader.newObjectReader("name");
        m.setName(decoder0.decode(reader, m.getName()));
        reader = rootReader.newObjectReader("password");
        m.setPassword(decoder0.decode(reader, m.getPassword(), biz.nirvani.storebiz.db.entity.customer.Password.class));
