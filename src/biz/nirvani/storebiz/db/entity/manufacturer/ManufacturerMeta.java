...
/** */
public final class ManufacturerMeta extends org.slim3.datastore.ModelMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer> {

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer, java.util.Date> creationDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer, java.util.Date>(this, "creationDate", "creationDate", java.util.Date.class);
    ...
    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer> manufacturerId = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer>(this, "manufacturerId", "manufacturerId");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer, com.google.appengine.api.datastore.Key> manufacturerKey = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer, com.google.appengine.api.datastore.Key>(this, "__key__", "manufacturerKey", com.google.appengine.api.datastore.Key.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer> manufacturerName = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer>(this, "manufacturerName", "manufacturerName");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer, java.util.Date> manufacturerRegistrationDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer, java.util.Date>(this, "manufacturerRegistrationDate", "manufacturerRegistrationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer, java.util.Date> manufacturerRegistrationExpiryDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer, java.util.Date>(this, "manufacturerRegistrationExpiryDate", "manufacturerRegistrationExpiryDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer> primaryAddressCountry = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer>(this, "primaryAddressCountry", "primaryAddressCountry");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer> primaryAddressCountryCode = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer>(this, "primaryAddressCountryCode", "primaryAddressCountryCode");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer> primaryAddressCounty = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer>(this, "primaryAddressCounty", "primaryAddressCounty");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer> primaryAddressCountyCode = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer>(this, "primaryAddressCountyCode", "primaryAddressCountyCode");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer> status = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer>(this, "status", "status");
    ...
    public ManufacturerMeta() {
        super("Manufacturer", biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer.class);
    }

    @Override
    public biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer entityToModel(com.google.appengine.api.datastore.Entity entity) {
        biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer model = new biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer();
    ...
    public com.google.appengine.api.datastore.Entity modelToEntity(java.lang.Object model) {
        biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer m = (biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer) model;
    ...
    protected long getVersion(Object model) {
        throw new IllegalStateException("The version property of the model(biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer) is not defined.");
    }
    ...
    @Override
    protected biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer jsonToModel(org.slim3.datastore.json.JsonRootReader rootReader, int maxDepth, int currentDepth) {
        biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer m = new biz.nirvani.storebiz.db.entity.manufacturer.Manufacturer();
