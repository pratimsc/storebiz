...
/** */
public final class AddressMeta extends org.slim3.datastore.ModelMeta<biz.nirvani.storebiz.db.entity.common.Address> {

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address> addressDisplayName = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address>(this, "addressDisplayName", "addressDisplayName");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, com.google.appengine.api.datastore.Key> addressKey = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, com.google.appengine.api.datastore.Key>(this, "__key__", "addressKey", com.google.appengine.api.datastore.Key.class);

    /** */
    public final org.slim3.datastore.StringCollectionAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, java.util.List<java.lang.String>> addressLines = new org.slim3.datastore.StringCollectionAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, java.util.List<java.lang.String>>(this, "addressLines", "addressLines", java.util.List.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address> addressOwnerType = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address>(this, "addressOwnerType", "addressOwnerType");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, java.util.Date> addressRegistrationDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, java.util.Date>(this, "addressRegistrationDate", "addressRegistrationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, java.util.Date> addressRegistrationExpiryDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, java.util.Date>(this, "addressRegistrationExpiryDate", "addressRegistrationExpiryDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address> addressType = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address>(this, "addressType", "addressType");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, com.google.appengine.api.datastore.Key> addressownerKey = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, com.google.appengine.api.datastore.Key>(this, "addressownerKey", "addressownerKey", com.google.appengine.api.datastore.Key.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address> city = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address>(this, "city", "city");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address> contactFullName = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address>(this, "contactFullName", "contactFullName");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address> country = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address>(this, "country", "country");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address> countryCode = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address>(this, "countryCode", "countryCode");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address> county = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address>(this, "county", "county");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address> countyCode = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address>(this, "countyCode", "countyCode");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, java.util.Date> creationDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, java.util.Date>(this, "creationDate", "creationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, java.util.Date> lastModificationDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, java.util.Date>(this, "lastModificationDate", "lastModificationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address> postCode = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address>(this, "postCode", "postCode");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, java.lang.Boolean> prefferedAddress = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.Address, java.lang.Boolean>(this, "prefferedAddress", "prefferedAddress", boolean.class);
    ...
    /** */
    public AddressMeta() {
        super("Address", biz.nirvani.storebiz.db.entity.common.Address.class);
    }

    @Override
    public biz.nirvani.storebiz.db.entity.common.Address entityToModel(com.google.appengine.api.datastore.Entity entity) {
        biz.nirvani.storebiz.db.entity.common.Address model = new biz.nirvani.storebiz.db.entity.common.Address();
        ...
        java.util.List<biz.nirvani.storebiz.db.entity.common.PhoneNumber> _phoneNumbers = blobToSerializable((com.google.appengine.api.datastore.Blob) entity.getProperty("phoneNumbers"));
    ...
    public com.google.appengine.api.datastore.Entity modelToEntity(java.lang.Object model) {
        biz.nirvani.storebiz.db.entity.common.Address m = (biz.nirvani.storebiz.db.entity.common.Address) model;
    ...
    protected long getVersion(Object model) {
        throw new IllegalStateException("The version property of the model(biz.nirvani.storebiz.db.entity.common.Address) is not defined.");
    }
    ...
    protected void modelToJson(org.slim3.datastore.json.JsonWriter writer, java.lang.Object model, int maxDepth, int currentDepth) {
        ...
        if(m.getPhoneNumbers() != null){
            ...
            // biz.nirvani.storebiz.db.entity.common.PhoneNumber is not supported.
        }
    ...
    @Override
    protected biz.nirvani.storebiz.db.entity.common.Address jsonToModel(org.slim3.datastore.json.JsonRootReader rootReader, int maxDepth, int currentDepth) {
        biz.nirvani.storebiz.db.entity.common.Address m = new biz.nirvani.storebiz.db.entity.common.Address();
