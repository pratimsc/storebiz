...
public final class CurableDiseasesMeta extends org.slim3.datastore.ModelMeta<biz.storebiz.db.entity.product.CurableDiseases> {
    ...
    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.CurableDiseases, com.google.appengine.api.datastore.Key> associatedProductKey = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.CurableDiseases, com.google.appengine.api.datastore.Key>(this, "associatedProductKey", "associatedProductKey", com.google.appengine.api.datastore.Key.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.CurableDiseases, com.google.appengine.api.datastore.Key> curableDiseaseKey = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.CurableDiseases, com.google.appengine.api.datastore.Key>(this, "__key__", "curableDiseaseKey", com.google.appengine.api.datastore.Key.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.product.CurableDiseases> curableDiseaseName = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.product.CurableDiseases>(this, "curableDiseaseName", "curableDiseaseName");
    ...
    public CurableDiseasesMeta() {
        super("CurableDiseases", biz.storebiz.db.entity.product.CurableDiseases.class);
    }

    @Override
    public biz.storebiz.db.entity.product.CurableDiseases entityToModel(com.google.appengine.api.datastore.Entity entity) {
        biz.storebiz.db.entity.product.CurableDiseases model = new biz.storebiz.db.entity.product.CurableDiseases();
    ...
    public com.google.appengine.api.datastore.Entity modelToEntity(java.lang.Object model) {
        biz.storebiz.db.entity.product.CurableDiseases m = (biz.storebiz.db.entity.product.CurableDiseases) model;
    ...
    protected long getVersion(Object model) {
        throw new IllegalStateException("The version property of the model(biz.storebiz.db.entity.product.CurableDiseases) is not defined.");
    }
    ...
    @Override
    protected biz.storebiz.db.entity.product.CurableDiseases jsonToModel(org.slim3.datastore.json.JsonRootReader rootReader, int maxDepth, int currentDepth) {
        biz.storebiz.db.entity.product.CurableDiseases m = new biz.storebiz.db.entity.product.CurableDiseases();
