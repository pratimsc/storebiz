...
public final class AppCurrencyMeta extends org.slim3.datastore.ModelMeta<biz.storebiz.db.entity.common.AppCurrency> {
    ...
    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.AppCurrency> baseCurrencyCode = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.AppCurrency>(this, "baseCurrencyCode", "baseCurrencyCode");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.AppCurrency, java.util.Date> creationDate = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.AppCurrency, java.util.Date>(this, "creationDate", "creationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.AppCurrency, com.google.appengine.api.datastore.Key> currencyKey = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.AppCurrency, com.google.appengine.api.datastore.Key>(this, "__key__", "currencyKey", com.google.appengine.api.datastore.Key.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.AppCurrency, java.lang.Long> decimalPositionAdjuster = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.AppCurrency, java.lang.Long>(this, "decimalPositionAdjuster", "decimalPositionAdjuster", long.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.AppCurrency> exchangeCurrencyCode = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.common.AppCurrency>(this, "exchangeCurrencyCode", "exchangeCurrencyCode");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.AppCurrency, java.lang.Long> exchangeRateWithoutDecimalAdjustement = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.common.AppCurrency, java.lang.Long>(this, "exchangeRateWithoutDecimalAdjustement", "exchangeRateWithoutDecimalAdjustement", long.class);
    ...
    public AppCurrencyMeta() {
        super("AppCurrency", biz.storebiz.db.entity.common.AppCurrency.class);
    }

    @Override
    public biz.storebiz.db.entity.common.AppCurrency entityToModel(com.google.appengine.api.datastore.Entity entity) {
        biz.storebiz.db.entity.common.AppCurrency model = new biz.storebiz.db.entity.common.AppCurrency();
    ...
    public com.google.appengine.api.datastore.Entity modelToEntity(java.lang.Object model) {
        biz.storebiz.db.entity.common.AppCurrency m = (biz.storebiz.db.entity.common.AppCurrency) model;
    ...
    protected long getVersion(Object model) {
        throw new IllegalStateException("The version property of the model(biz.storebiz.db.entity.common.AppCurrency) is not defined.");
    }
    ...
    @Override
    protected biz.storebiz.db.entity.common.AppCurrency jsonToModel(org.slim3.datastore.json.JsonRootReader rootReader, int maxDepth, int currentDepth) {
        biz.storebiz.db.entity.common.AppCurrency m = new biz.storebiz.db.entity.common.AppCurrency();
