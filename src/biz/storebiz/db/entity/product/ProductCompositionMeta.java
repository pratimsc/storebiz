...
/** */
public final class ProductCompositionMeta extends org.slim3.datastore.ModelMeta<biz.storebiz.db.entity.product.ProductComposition> {

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductComposition, com.google.appengine.api.datastore.Key> associatedProductKey = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductComposition, com.google.appengine.api.datastore.Key>(this, "associatedProductKey", "associatedProductKey", com.google.appengine.api.datastore.Key.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.product.ProductComposition> compositionName = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.product.ProductComposition>(this, "compositionName", "compositionName");

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.product.ProductComposition> compositionValue = new org.slim3.datastore.StringAttributeMeta<biz.storebiz.db.entity.product.ProductComposition>(this, "compositionValue", "compositionValue");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductComposition, com.google.appengine.api.datastore.Key> productCompositionKey = new org.slim3.datastore.CoreAttributeMeta<biz.storebiz.db.entity.product.ProductComposition, com.google.appengine.api.datastore.Key>(this, "__key__", "productCompositionKey", com.google.appengine.api.datastore.Key.class);
    ...
    public ProductCompositionMeta() {
        super("ProductComposition", biz.storebiz.db.entity.product.ProductComposition.class);
    }

    @Override
    public biz.storebiz.db.entity.product.ProductComposition entityToModel(com.google.appengine.api.datastore.Entity entity) {
        biz.storebiz.db.entity.product.ProductComposition model = new biz.storebiz.db.entity.product.ProductComposition();
    ...
    public com.google.appengine.api.datastore.Entity modelToEntity(java.lang.Object model) {
        biz.storebiz.db.entity.product.ProductComposition m = (biz.storebiz.db.entity.product.ProductComposition) model;
    ...
    protected long getVersion(Object model) {
        throw new IllegalStateException("The version property of the model(biz.storebiz.db.entity.product.ProductComposition) is not defined.");
    }
    ...
    @Override
    protected biz.storebiz.db.entity.product.ProductComposition jsonToModel(org.slim3.datastore.json.JsonRootReader rootReader, int maxDepth, int currentDepth) {
        biz.storebiz.db.entity.product.ProductComposition m = new biz.storebiz.db.entity.product.ProductComposition();
