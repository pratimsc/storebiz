...
/** */
public final class WarehouseLocationMeta extends org.slim3.datastore.ModelMeta<biz.nirvani.storebiz.db.entity.common.WarehouseLocation> {
    ...
    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.WarehouseLocation, java.util.Date> creationDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.WarehouseLocation, java.util.Date>(this, "creationDate", "creationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.WarehouseLocation, com.google.appengine.api.datastore.Key> postalAddress = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.WarehouseLocation, com.google.appengine.api.datastore.Key>(this, "postalAddress", "postalAddress", com.google.appengine.api.datastore.Key.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.WarehouseLocation> warehouseLocationCode = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.WarehouseLocation>(this, "warehouseLocationCode", "warehouseLocationCode");

    /** */
    public final org.slim3.datastore.UnindexedAttributeMeta<biz.nirvani.storebiz.db.entity.common.WarehouseLocation, com.google.appengine.api.datastore.Text> warehouseLocationDetailDescription = new org.slim3.datastore.UnindexedAttributeMeta<biz.nirvani.storebiz.db.entity.common.WarehouseLocation, com.google.appengine.api.datastore.Text>(this, "warehouseLocationDetailDescription", "warehouseLocationDetailDescription", com.google.appengine.api.datastore.Text.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.WarehouseLocation, com.google.appengine.api.datastore.Key> warehouseLocationKey = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.common.WarehouseLocation, com.google.appengine.api.datastore.Key>(this, "__key__", "warehouseLocationKey", com.google.appengine.api.datastore.Key.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.WarehouseLocation> warehouseLocationShortDescription = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.common.WarehouseLocation>(this, "warehouseLocationShortDescription", "warehouseLocationShortDescription");
    ...
    public WarehouseLocationMeta() {
        super("WarehouseLocation", biz.nirvani.storebiz.db.entity.common.WarehouseLocation.class);
    }

    @Override
    public biz.nirvani.storebiz.db.entity.common.WarehouseLocation entityToModel(com.google.appengine.api.datastore.Entity entity) {
        biz.nirvani.storebiz.db.entity.common.WarehouseLocation model = new biz.nirvani.storebiz.db.entity.common.WarehouseLocation();
    ...
    public com.google.appengine.api.datastore.Entity modelToEntity(java.lang.Object model) {
        biz.nirvani.storebiz.db.entity.common.WarehouseLocation m = (biz.nirvani.storebiz.db.entity.common.WarehouseLocation) model;
    ...
    protected long getVersion(Object model) {
        throw new IllegalStateException("The version property of the model(biz.nirvani.storebiz.db.entity.common.WarehouseLocation) is not defined.");
    }
    ...
    @Override
    protected biz.nirvani.storebiz.db.entity.common.WarehouseLocation jsonToModel(org.slim3.datastore.json.JsonRootReader rootReader, int maxDepth, int currentDepth) {
        biz.nirvani.storebiz.db.entity.common.WarehouseLocation m = new biz.nirvani.storebiz.db.entity.common.WarehouseLocation();
