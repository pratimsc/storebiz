...
/** */
public final class ProductDiscountMeta extends org.slim3.datastore.ModelMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount> {

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.lang.Boolean> applicableForInStoreSale = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.lang.Boolean>(this, "applicableForInStoreSale", "applicableForInStoreSale", boolean.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.lang.Boolean> applicanleForOnlineSale = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.lang.Boolean>(this, "applicanleForOnlineSale", "applicanleForOnlineSale", boolean.class);
    ...
    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.lang.Boolean> associatedWithCustomer = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.lang.Boolean>(this, "associatedWithCustomer", "associatedWithCustomer", boolean.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.lang.Boolean> associatedWithOrder = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.lang.Boolean>(this, "associatedWithOrder", "associatedWithOrder", boolean.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.lang.Boolean> associatedWithProduct = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.lang.Boolean>(this, "associatedWithProduct", "associatedWithProduct", boolean.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.util.Date> creationDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.util.Date>(this, "creationDate", "creationDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount> discountCode = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount>(this, "discountCode", "discountCode");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.util.Date> discountEndDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.util.Date>(this, "discountEndDate", "discountEndDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount> discountUnit = new org.slim3.datastore.StringAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount>(this, "discountUnit", "discountUnit");

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.lang.Integer> discountValue = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.lang.Integer>(this, "discountValue", "discountValue", int.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.util.Date> discoutStartDate = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, java.util.Date>(this, "discoutStartDate", "discoutStartDate", java.util.Date.class);

    /** */
    public final org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, com.google.appengine.api.datastore.Key> productDiscountKey = new org.slim3.datastore.CoreAttributeMeta<biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount, com.google.appengine.api.datastore.Key>(this, "__key__", "productDiscountKey", com.google.appengine.api.datastore.Key.class);
    ...
    public ProductDiscountMeta() {
        super("ProductDiscount", biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount.class);
    }

    @Override
    public biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount entityToModel(com.google.appengine.api.datastore.Entity entity) {
        biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount model = new biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount();
    ...
    public com.google.appengine.api.datastore.Entity modelToEntity(java.lang.Object model) {
        biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount m = (biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount) model;
    ...
    protected long getVersion(Object model) {
        throw new IllegalStateException("The version property of the model(biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount) is not defined.");
    }
    ...
    @Override
    protected biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount jsonToModel(org.slim3.datastore.json.JsonRootReader rootReader, int maxDepth, int currentDepth) {
        biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount m = new biz.nirvani.storebiz.db.entity.discount.product.ProductDiscount();
